...
class Agent():
    ...
    def init_bins(self, lower_bound, upper_bound, num_bins):
        ...
        """
        # Begin your code
        # create an list of arithmetic sequence(include lower_bound and upper_bound)
        bins= np.linspace(lower_bound, upper_bound, num_bins+1)
        # delete the head and tail
        bins= np.delete(bins, num_bins)
    ...
    def discretize_value(self, value, bins):
        ...
        """
        # Begin your code
        # discretize the value, find the value is in which interval
        x= np.searchsorted(bins, value, side='right')
        return x
        raise NotImplementedError("Not implemented yet.")
        # End your code
    ...
    def discretize_observation(self, observation):
        ...
        # Begin your code
        # Discretize the observation which we observed from a continuous state space.
        # Observation is a list of 4 features.
        state=[]
    ...
    def learn(self, state, action, reward, next_state, done):
        ...
        """
        # Begin your code
        # calculate q value and update the qtable (using tuple)
    ...
    def check_max_Q(self):
        ...
        """
        # Begin your code
        # Discretize and find the max q
        max_q= max(self.qtable[self.discretize_observation(self.env.reset())])
        return max_q
        raise NotImplementedError("Not implemented yet.")
        # End your code
